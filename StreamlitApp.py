...
# def main():
#     st.set_page_config("QnA from the given Document")
    
#     doc=st.file_uploader("Upload your document")
    
#     st.header("QnA from the given Document")
...
#     # Create a form to capture user input and submit on pressing "Enter" or clicking the "Submit" button
#     with st.form(key="qa_form"):
#         user_question = st.text_input("Ask your question")
#         submit_button = st.form_submit_button("Submit")  # This will trigger when the user presses "Enter" or clicks "Submit"
